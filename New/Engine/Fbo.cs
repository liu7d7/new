...
public sealed class Fbo
{
  ...
  {
    GL.BindFramebuffer(FramebufferTarget.Framebuffer, other);
    BindColor(0);
    RenderSystem.BLIT.Bind();
    RenderSystem.POST.Render();
    Image2d.Unbind();
  }
  
  public void GLBlit(int other = 0)
  {
