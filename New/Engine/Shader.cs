...
public sealed class Shader
{
  ...
  public readonly Vec<ShaderSetting> Settings = new();
  public readonly String Name;
  
  public static readonly Vec<Shader> Shaders = new(); 
  
  private readonly Dictionary<string, int> _uniformLocations = new();

  public Shader(string vertPath, string fragPath, string geomPath = null)
  {
    Name = vertPath + "/" + (geomPath ?? "null") + "/" + fragPath;
    ...
    {
      string key = GL.GetActiveUniform(Handle, i, out _, out ActiveUniformType t);
